...
namespace BtoB\SocialNetwork\CoreBundle\Command;
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(sprintf('Programmed to send messages <info>%s</info>... ', $i));
        $em->flush();
    ...
    {
        $container = $this->getContainer();
        return $container->get('btob.mailer.twig_swift');
    }
}
